...
public class LITNuovo50xWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITNuovo50xWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITNuovo50xWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITNuovo50xWLAIW/InitOutcome.xml").getDocumentElement();
